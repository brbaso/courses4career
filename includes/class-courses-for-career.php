...
class Courses_For_Career {
	...
	private function adding_shortcode() {
		...
		// add shortcode
		add_shortcode( 'courses4career', array( 'Courses_For_Career_Shortcode', 'courses_for_careershortcode_func' ) );
	}
	...
	*/
	...
	private function define_public_hooks() {
		...
		// add public widget ajax C4C_Widget_Ajax
		$plugin_c4c_ajax = new C4C_Widget_Ajax( $dbhandle );
